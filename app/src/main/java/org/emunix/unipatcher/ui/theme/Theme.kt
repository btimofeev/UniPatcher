...
private val LightRedScheme = lightColorScheme(
    ...
    inverseSurface = Color(0xFF3B2B23),
    inverseOnSurface = Color(0xFFF2DED3),
...
private val DarkRedScheme = darkColorScheme(
    ...
    inverseSurface = Color(0xFFF2DED3),
    inverseOnSurface = Color(0xFF3B2B23),
    inversePrimary = Color(0xFF8F4B3E),
